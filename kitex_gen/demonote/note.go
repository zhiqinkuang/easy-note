...
type UpdateNoteRequest struct {
	...
	Cotent *string `thrift:"cotent,4,optional" frugal:"4,optional,string" json:"cotent,omitempty"`
}
...
var UpdateNoteRequest_Cotent_DEFAULT string

func (p *UpdateNoteRequest) GetCotent() (v string) {
	if !p.IsSetCotent() {
		return UpdateNoteRequest_Cotent_DEFAULT
	}
	return *p.Cotent
}
...
func (p *UpdateNoteRequest) SetCotent(val *string) {
	p.Cotent = val
}
...
func (p *UpdateNoteRequest) IsSetCotent() bool {
	return p.Cotent != nil
}
...
func (p *UpdateNoteRequest) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetCotent() {
		if err = oprot.WriteFieldBegin("cotent", thrift.STRING, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.Cotent); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *UpdateNoteRequest) DeepEqual(ano *UpdateNoteRequest) bool {
	...
	if !p.Field4DeepEqual(ano.Cotent) {
		return false
	}
	return true
}
...
func (p *UpdateNoteRequest) Field4DeepEqual(src *string) bool {
	...
	if p.Cotent == src {
		return true
	} else if p.Cotent == nil || src == nil {
		return false
	}
	if strings.Compare(*p.Cotent, *src) != 0 {
		return false
	}
	return true
}
