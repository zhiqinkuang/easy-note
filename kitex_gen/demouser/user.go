...
const (
	...
	ErrCode_UserAlreadyExistCode       ErrCode = 10003
	ErrCode_AuthoriztionFailerdErrCode ErrCode = 10004
)
...
func (p ErrCode) String() string {
	...
	case ErrCode_ParamErrCode:
		return "ParamErrCode"
	case ErrCode_UserAlreadyExistCode:
		return "UserAlreadyExistCode"
	case ErrCode_AuthoriztionFailerdErrCode:
		return "AuthoriztionFailerdErrCode"
	}
	return "<UNSET>"
}
...
func ErrCodeFromString(s string) (ErrCode, error) {
	...
	case "UserAlreadyExistCode":
		return ErrCode_UserAlreadyExistCode, nil
	case "AuthoriztionFailerdErrCode":
		return ErrCode_AuthoriztionFailerdErrCode, nil
	}
